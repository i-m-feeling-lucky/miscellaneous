...
- Hexo: 使用人数非常多，简单、实用、方便，但是主题系统太过于静态，对Markdown渲染的配置不够灵活
- VuePress: Vue官方出品，专注于做以内容为中心的静态网站，能很方便得和我们的前端整合到一起，而且它本身就提供了一些为技术文档定制的开箱即用的主题和特性
- WordPress: 是做网站很好的工具，但过于复杂，并不太适合生成文档
- jekyll：简单、方便，但是主题较少、灵活性低
